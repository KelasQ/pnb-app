        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item">
                ...
                <ul id="masterDataKlaster" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
                    ...
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ url('subKlaster') }}">Data Sub
                            Klaster</a>
                    </li>
                </ul>
            </li>
            <li class="sidebar-item">
                ...
                <ul id="masterDataBantuan" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ url('bantuan') }}">Data Bantuan</a>
                    </li>
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ url('subBantuan') }}">Data Sub
                            Bantuan</a>
                    </li>
                </ul>
            </li>
