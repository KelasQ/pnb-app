                                ...
                                <form action="{{ route('tindakan.store') }}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="peserta_id" id="peserta_id"
                                            ...
                                            @foreach ($peserta as $peserta)
                                                <option value="{{ $peserta->id }}">{{ $peserta->nik }} -
                                    ...
                                    <div class="form-group mt-2">
                                        ...
                                        <select name="tindakan" id="tindakan"
                                            ...
                                            <option value="Layanan">Program/Layanan</option>
                                    ...
                                    <div class="form-layanan d-none">
                                        <div class="form-group mt-2">
                                            ...
                                            <select name="sub_layanan" id="sub_layanan"
                                                ...
                                                <option value="Pengasramaan">Pengasramaan</option>
                                            </select>
                                            @error('sub_layanan')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                        ...
                                        <div class="form-intervensi d-none">
                                            <div class="form-group mt-2">
                                                <label for="kategori_intervensi">Kategori Intervensi</label>
                                                <input type="text" name="kategori_intervensi" id="kategori_intervensi"
                                                    placeholder="Kategori Intervensi"
                                                    class="form-control @error('kategori_intervensi') is-invalid @enderror">
                                                @error('kategori_intervensi')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                                @enderror
                                        ...
                                        <div class="form-asrama d-none">
                                            ...
                                            <div class="form-group mt-2">
                                                ...
                                                <input type="text" name="nama_asrama" id="nama_asrama"
                                                    ...
                                                    placeholder="Nama Asrama" value="{{ old('nama_asrama') }}">
                                                @error('nama_asrama')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="form-group mt-2">
                                            ...
                                            <textarea name="deskripsi_layanan" id="deskripsi_layanan" cols="30" rows="3"
                                                class="form-control @error('deskripsi_layanan') is-invalid @enderror" placeholder="Deskripsi Layanan">{{ old('deskripsi_layanan') }}</textarea>
                                    ...
                                    <div class="form-terminasi d-none">
                                        ...
                                        <div class="form-group mt-2">
                                            ...
                                            <textarea name="alasan_terminasi" id="alasan_terminasi" cols="30" rows="3" placeholder="Alasan Terminasi"
                                                class="form-control @error('alasan_terminasi') is-invalid @enderror">{{ old('alasan_terminasi') }}</textarea>
                                        ...
                                        <div class="form-group mt-2">
                                            ...
                                            <select name="syarat_dan_ketentuan[]" id="syarat_dan_ketentuan"
                                                ...
                                                multiple="multiple">
                                                <option value="Telah Menerima Layanan">Telah Menerima Layanan</option>
                                                <option value="Permintaan Sendiri">Permintaan Sendiri</option>
                                                <option value="Pernah Melakukan Pelanggaran">Pernah Melakukan Pelanggaran
                                                </option>
                                            </select>
                                    ...
                                    <div class="form-group mt-2">
                                        ...
                                        <textarea name="deskripsi_masalah" id="deskripsi_masalah" cols="30" rows="3"
                                            class="form-control @error('deskripsi_masalah') is-invalid @enderror" placeholder="Deskripsi Masalah">{{ old('deskripsi_masalah') }}</textarea>
                                    ...
                                    <div class="form-group mt-2">
                                        ...
                                        <textarea name="deskripsi_hasil" id="deskripsi_hasil" cols="30" rows="3"
                                            class="form-control @error('deskripsi_hasil') is-invalid @enderror" placeholder="Deskripsi Hasil">{{ old('deskripsi_hasil') }}</textarea>
                                    ...
                                    <div class="form-group mt-2">
                                        ...
                                        <textarea name="rencana_tindak_lanjut" id="rencana_tindak_lanjut" cols="30" rows="3"
                                            class="form-control @error('rencana_tindak_lanjut') is-invalid @enderror" placeholder="Rencana Tindak Lanjut">{{ old('rencana_tindak_lanjut') }}</textarea>
